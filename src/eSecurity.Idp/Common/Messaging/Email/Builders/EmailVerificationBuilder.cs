...
public sealed class EmailVerificationContext : EmailContext
{
    public required string Code { get; set; }
}

public sealed class EmailVerificationBuilder : IEmailBuilder<EmailVerificationContext>
{
    public string Build(EmailVerificationContext context)
    {
        return $"""
                <!doctype html>
                <html lang="en">
