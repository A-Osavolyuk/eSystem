...
public sealed class CodeVerificationEmailContext : EmailContext
{
    public required string Code { get; set; }
}

public sealed class CodeVerificationEmailBuilder : IEmailBuilder<CodeVerificationEmailContext>
{
    public string Build(CodeVerificationEmailContext context)
    {
        return $"""
                <!doctype html>
                <html lang="en">
