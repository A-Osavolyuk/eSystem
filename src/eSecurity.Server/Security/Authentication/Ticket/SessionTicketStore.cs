...
namespace eSecurity.Server.Security.Authentication.Ticket;
    ...
    IDataProtectionProvider protectionProvider) : ITicketStore
{
    ...
    public async Task<string> StoreAsync(AuthenticationTicket ticket)
    {
        ...
        session.Properties = new SessionPropertiesEntity
        {
            ...
            ExpiredAt = ticket.Properties.ExpiresUtc,
    ...
    public async Task RenewAsync(string key, AuthenticationTicket ticket)
    {
        ...
        {
            session.Properties.ExpiredAt = ticket.Properties.ExpiresUtc;
    ...
    public async Task<AuthenticationTicket?> RetrieveAsync(string key)
    {
        ...
        if (session.Properties.ExpiredAt.HasValue && session.Properties.ExpiredAt.Value < DateTimeOffset.UtcNow)
        {
        ...
        var authenticationProperties = new AuthenticationProperties
        {
            ...
            IssuedUtc = session.Properties.IssuedAt,
