...
public interface IUserManager
{
    ...
    public ValueTask<Result> SetLockoutEnabledAsync(UserEntity user, bool state, CancellationToken cancellationToken = default);
    ...
    public ValueTask<Result> UnlockUserAsync(UserEntity user, CancellationToken cancellationToken = default);
