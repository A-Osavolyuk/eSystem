...
namespace eShop.Auth.Api.Migrations
{
    ...
    [Migration("20250220131506_RenamedSentToProperty")]
    partial class RenamedSentToProperty
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eShop.Auth.Api.Entities.AppRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("eShop.Auth.Api.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "8464a3ed-8df8-4bb2-acbe-fce5a39462d8",
            ...
            modelBuilder.Entity("eShop.Auth.Api.Entities.PersonalDataEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("05a05396-a493-44a1-b8ca-9ea87550bb17"),
                            CreateDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("eShop.Auth.Api.Entities.AppRole", null)
                        .WithMany()
