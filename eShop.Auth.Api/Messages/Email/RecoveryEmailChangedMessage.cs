...
public class RecoveryEmailChangedMessage : Message
{
    public override string Build()
    {
                return $"""
                     ...
                     <head>
                         ...
                         <title>Recovery email changed</title>
                     </head>
                     <body>
                     <div style="border: 1px solid rgb(190, 189, 189); width: 800px; margin: auto; padding: 1px;">
                         ...
                         <div style="padding: 50px 100px; margin: auto;">
                             <h1 style="font: bold 24px Arial, sans-serif; margin: 0; margin-bottom: 40px;">Recovery email changed</h1>
                             <p style="font: 16px Arial, sans-serif; margin:0;">Hello, {Payload["UserName"]}!.</p>
                             <br>
                             <p style="font: 16px Arial, sans-serif; margin: 0;">
                                Your recovery email address has been changed.
                                If it was not you, you can rollback it.
                             </p>
                             <p style="font: 16px Arial, sans-serif; margin: 0;">
                                 To rollback your recovery email address, please, enter code from below.
                             </p>
                             <br>
                             <p style="font: 16px Arial, sans-serif; margin: 0;"> Your rollback code: {Payload["Code"]}.</p>
                             <br>
                             <p style="font: 16px Arial, sans-serif; margin: 0;">
