    ...
    public override string Build()
    {
        return $"""
                     ...
                     <head>
                         ...
                         <title>Recovery email verification (step two)</title>
                     </head>
                     <body>
                     <div style="border: 1px solid rgb(190, 189, 189); width: 800px; margin: auto; padding: 1px;">
                         ...
                         <div style="padding: 50px 100px; margin: auto;">
                             <h1 style="font: bold 24px Arial, sans-serif; margin: 0; margin-bottom: 40px;">Recovery email verification (step two)</h1>
                             <p style="font: 16px Arial, sans-serif; margin:0;">Hello, {Payload["UserName"]}!.</p>
                             <br>
                             <p style="font: 16px Arial, sans-serif; margin: 0;">
                                 To complete recovery email change, you need to verify your new recovery email address.
                                 To verify your new recovery email addrees, please enter 6-digit verification code from below.
                             </p>
                             <br>
