    ...
    public override string Build()
    {
        return $"""
                    ...
                    <head>
                        ...
                        <title>2FA provider verification</title>
                    </head>
                    <body>
                    <div style="border: 1px solid rgb(190, 189, 189); width: 800px; margin: auto; padding: 1px;">
                        ...
                        <div style="padding: 50px 100px; margin: auto;">
                            <h1 style="font: bold 24px Arial, sans-serif; margin: 0; margin-bottom: 40px;">2FA provider verification</h1>
                            <p style="font: 16px Arial, sans-serif; margin:0;">Hello, {Payload["UserName"]}!.</p>
                            <br>
                            <p style="font: 16px Arial, sans-serif; margin: 0;">
                                 To verify 2FA with Email, please, enter 6-digit code from below.
                            </p>
                            <br>
                            <p style="font: 16px Arial, sans-serif; margin: 0;"> 
                                 Your 2FA provider verification code: {Payload["Code"]}. Will expire in: 10 mins.</p>
                            <br>
                            <p style="font: 16px Arial, sans-serif; margin: 0;">
