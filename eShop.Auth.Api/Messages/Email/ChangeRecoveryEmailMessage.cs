...
public class ChangeRecoveryEmailMessage : Message
{
    public override string Build()
    {
        return $"""
                    ...
                    <head>
                        ...
                        <title>Recovery email change (step one)</title>
                    </head>
                    <body>
                    <div style="border: 1px solid rgb(190, 189, 189); width: 800px; margin: auto; padding: 1px;">
                        ...
                        <div style="padding: 50px 100px; margin: auto;">
                            <h1 style="font: bold 24px Arial, sans-serif; margin: 0; margin-bottom: 40px;">Recovery email change (step one)</h1>
                            <p style="font: 16px Arial, sans-serif; margin:0;">Hello, {Payload["UserName"]}!.</p>
                            <br>
                            <p style="font: 16px Arial, sans-serif; margin: 0;">
                                We received a request to change your current recovery email to new recovery email: {Payload["NewRecoveryEmail"]}.
                                To confirm the first step of a recovery email change, please enter the confirmation code from this letter.
                            </p>
                            <br>
