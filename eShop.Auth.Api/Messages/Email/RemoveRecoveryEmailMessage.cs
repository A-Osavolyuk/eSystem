...
public class RemoveRecoveryEmailMessage : Message
{
    public override string Build()
    {
        return $"""
                     ...
                     <head>
                         ...
                         <title>Recovery email remove</title>
                     </head>
                     <body>
                     <div style="border: 1px solid rgb(190, 189, 189); width: 800px; margin: auto; padding: 1px;">
                         ...
                         <div style="padding: 50px 100px; margin: auto;">
                             <h1 style="font: bold 24px Arial, sans-serif; margin: 0; margin-bottom: 40px;">Recovery email remove</h1>
                             <p style="font: 16px Arial, sans-serif; margin:0;">Hello, {Payload["UserName"]}!.</p>
                             <br>
                             <p style="font: 16px Arial, sans-serif; margin: 0;">
                                 You requested your current recovery email remove.
                                 To remove your current recovery email, please enter 6-digit code from below.
                             </p>
                             <br>
