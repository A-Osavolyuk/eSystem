...
public class UnblockDeviceMessage : Message
{
        ...
        return $"""
                     ...
                     <div style="border: 1px solid rgb(190, 189, 189); width: 800px; margin: auto; padding: 1px;">
                         ...
                         <div style="padding: 50px 100px; margin: auto;">
                             <h1 style="font: bold 24px Arial, sans-serif; margin: 0; margin-bottom: 40px;">Device unblock</h1>
                             ...
                             <br>
                             <p style="font: 16px Arial, sans-serif; margin: 0;">
                                 To unblock device, please enter 6-digit code from below.
                             </p>
                             <br>
                             <p style="font: 16px Arial, sans-serif; margin: 0;"> Your unblock code: {Payload["Code"]}. Will expire in: 10 mins.</p>
                             <br>
                             <p style="font: 16px Arial, sans-serif; margin: 0;">
