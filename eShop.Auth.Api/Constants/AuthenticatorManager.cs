namespace eShop.Auth.Api.Constants;

public class AuthenticatorManager
{
    private static readonly Dictionary<Guid, string> Authenticators = new()
    {
        ...
        { Guid.Parse("891494da-2c90-4d31-a9cd-4eab0aed1309"), "Sésame" },
        ...
        { Guid.Parse("39a5647e-1853-446c-a1f6-a79bae9f5bc7"), "IDmelon" },
        ...
        { Guid.Parse("66a0ccb3-bd6a-191f-ee06-e375c50b9846"), "Thales Bio iOS SDK" },
        { Guid.Parse("8836336a-f590-0921-301d-46427531eee6"), "Thales Bio Android SDK" },
        { Guid.Parse("cd69adb5-3c7a-deb9-3177-6800ea6cb72a"), "Thales PIN Android SDK" },
        { Guid.Parse("17290f1e-c212-34d0-1423-365d729f09d9"), "Thales PIN iOS SDK" },
        { Guid.Parse("50726f74-6f6e-5061-7373-50726f746f6e"), "Proton Pass" },
        { Guid.Parse("fdb141b2-5d84-443e-8a35-4698c205a502"), "KeePassXC" },
        { Guid.Parse("cc45f64e-52a2-451b-831a-4edd8022a202"), "ToothPic Passkey Provider" },
        { Guid.Parse("bfc748bb-3429-4faa-b9f9-7cfa9f3b76d0"), "iPasswords" },
        ...
        { Guid.Parse("d350af52-0351-4ba2-acd3-dfeeadc3f764"), "pwSafe" },
        { Guid.Parse("d3452668-01fd-4c12-926c-83a4204853aa"), "Microsoft Password Manager" },
        { Guid.Parse("6d212b28-a2c1-4638-b375-5932070f62e9"), "initial" }
    };

    public static bool Verify(Guid aaguid) => Authenticators.ContainsKey(aaguid);
}