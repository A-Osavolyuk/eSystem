using eShop.Blazor.Domain.Models.Products;

namespace eShop.Blazor.Application.Validation.Products;

public class BerryPropertiesValidator : PropertiesValidator<BerryPropertiesModel>
{
    public BerryPropertiesValidator()
    {
        RuleFor(x => x.Color)
