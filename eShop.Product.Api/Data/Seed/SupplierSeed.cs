    ...
    public override List<SupplierEntity> Get()
    {
        ...
        [
            new SupplierEntity
            {
                ...
                WebsiteUrl = "https://www.globalfreshfarms.com",
            ...
            new SupplierEntity
            {
                ...
                WebsiteUrl = "https://www.greenvalleydist.com",
            ...
            new SupplierEntity
            {
                ...
                WebsiteUrl = "https://www.sunriseagro.com",
            ...
            new SupplierEntity
            {
                ...
                WebsiteUrl = "https://www.tropicalfruitimports.com",
            ...
            new SupplierEntity
            {
                ...
                WebsiteUrl = "https://www.freshrootscoop.org",
